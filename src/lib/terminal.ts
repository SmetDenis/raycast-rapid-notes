...
// Verified locally by Info.plist: Ghostty, kitty. Alacritty/WezTerm ids are from their published
// manifests (not verified on this machine); a wrong id is a harmless no-op (no auto-clipboard for
// that app, i.e. the current behaviour), never a crash.
