...
- **Append Note** — a form to edit the selected/typed text before appending.
- **Append Note (Silent)** — instantly append the current selection, no UI.
- **New Note** — create a timestamped note with `created` / `tags` / `title` frontmatter.
